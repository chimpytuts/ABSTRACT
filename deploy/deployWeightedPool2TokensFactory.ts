...
export default async function (hre: HardhatRuntimeEnvironment) {
  console.log(`Running deploy script for WeightedPool2TokensFactory`);
  ...
  const artifact = await deployer.loadArtifact("WeightedPool2TokensFactory");
  ...
  // Deploy the contract
  console.log("\nDeploying WeightedPool2TokensFactory...");
